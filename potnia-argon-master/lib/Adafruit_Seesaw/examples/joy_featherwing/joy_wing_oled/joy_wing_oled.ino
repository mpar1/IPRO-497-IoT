...
void loop()
{
  ...
  if (!digitalRead(IRQ_PIN))
  {
    ...
    if (!(buttons & (1 << BUTTON_DOWN)))
    {
      ...
      tft.fillCircle(30, 18, 10, ST7735_BLACK);
    ...
    if (!(buttons & (1 << BUTTON_RIGHT)))
    {
      ...
      tft.fillCircle(10, 40, 10, ST7735_BLACK);
    ...
    if (!(buttons & (1 << BUTTON_LEFT)))
    {
      ...
      tft.fillCircle(50, 40, 10, ST7735_BLACK);
    ...
    if (!(buttons & (1 << BUTTON_UP)))
    {
      ...
      tft.fillCircle(30, 57, 10, ST7735_BLACK);
    ...
    if (!(buttons & (1 << BUTTON_START)))
    {
      ...
      tft.fillCircle(80, 40, 7, ST7735_BLACK);
  }
  delay(10);
}
